            ...
            <b-card title="Card Title" no-body>
              <b-card-header header-tag="nav">
                <b-nav card-header tabs>
                  <b-nav-item><router-link to="/mypage"></router-link>내 정보</b-nav-item>
                  <b-nav-item><router-link to="/mybookmarks"></router-link>내 북마크</b-nav-item>
                  <b-nav-item active> <router-link to="/myplans"></router-link>내 플랜</b-nav-item>
                </b-nav>
              </b-card-header>
